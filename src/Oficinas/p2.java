...
public class p2 extends BranchGroup {
    ...
    public p2(boolean conPiso,List<ObjetoConColision> listaObstaculos) {
        ...
        if (conPiso) {
            tgSalon.addChild(crearPared(9.0f, 0.46f, 6.0f,
                    new Vector3d(1.5, -0.2, 0.0), crearApariencia(160, 160, 160)));
        }
        tgSalon.addChild(Pared.crearParedConColision(0.1f, 3.0f, 3.7f,
                new Vector3d(3.0, 1.5, -1.1), crearApariencia(228, 199, 124), "paredLargaPasilloDer", listaObstaculos));
        tgSalon.addChild(Pared.crearParedConColision(0.4f, 3.0f, 0.90f,
                new Vector3d(3.0, 1.5, 0.9), crearApariencia(240, 210, 135), "pilarPasilloDer", listaObstaculos));

        tgSalon.addChild(Pared.crearParedConColision(6.0f, 3.0f, 0.1f,
                new Vector3d(0.0, 1.5, 0.9), crearApariencia(254, 216, 116), "paredSeparadoraCentral", listaObstaculos));

        tgSalon.addChild(Pared.crearParedConColision(6.0f, 3.0f, 0.1f,
                new Vector3d(0.0, 1.5, -3.0), crearApariencia(254, 216, 116), "paredEscaleraFondo", listaObstaculos));

        tgSalon.addChild(Pared.crearParedConColision(0.1f, 1.0f, 6.0f,
                new Vector3d(-3.0, 0.5, 0.0), crearApariencia(228, 199, 124), "paredIzqInferior", listaObstaculos));
        tgSalon.addChild(Pared.crearParedConColision(0.4f, 3.0f, 1.0f,
                new Vector3d(-2.8, 1.5, 1.0), crearApariencia(240, 210, 135), "pilarIzqCentro", listaObstaculos));
        ...
        tgSalon.addChild(Pared.crearParedConColision(0.1f, 1.4f, 1.1f,
                new Vector3d(-3.0, 1.7, 2.1), Color.setSemiTransparente(0.2f), "ventanaRef5", listaObstaculos));
        tgSalon.addChild(Pared.crearParedConColision(0.1f, 1.4f, 1.1f,
                new Vector3d(-3.0, 1.7, 1.0), Color.setSemiTransparente(0.2f), "ventanaRef6", listaObstaculos));
        tgSalon.addChild(Pared.crearParedConColision(0.1f, 1.4f, 1.1f,
                new Vector3d(-3.0, 1.7, -2.1), Color.setSemiTransparente(0.2f), "ventanaRef7", listaObstaculos));
        tgSalon.addChild(Pared.crearParedConColision(0.1f, 1.4f, 1.1f,
                new Vector3d(-3.0, 1.7, -1.0), Color.setSemiTransparente(0.2f), "ventanaRef8", listaObstaculos));

        tgSalon.addChild(Pared.crearParedConColision(0.1f, 3.0f, 0.3f,
                new Vector3d(-3.0, 1.5, 2.8), crearApariencia(228, 199, 124), "pilarIzqFrente", listaObstaculos));
        tgSalon.addChild(Pared.crearParedConColision(0.1f, 3.0f, 0.3f,
                new Vector3d(-3.0, 1.5, -2.8), crearApariencia(228, 199, 124), "pilarIzqFondo", listaObstaculos));
        ...
        tgSalon.addChild(Pared.crearParedConColision(0.1f, 1.5f, 6.0f,
                new Vector3d(-1.3, 1.0, 4.0), crearApariencia(155, 80, 15), "paredFrontalFondo", listaObstaculos));
        tgSalon.addChild(Pared.crearParedConColision(0.1f, 0.4f, 6.0f,
                new Vector3d(-1.3, 2.7, 4.0), crearApariencia(155, 80, 15), "paredFrontalFondo", listaObstaculos));
