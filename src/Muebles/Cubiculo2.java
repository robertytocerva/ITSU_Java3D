...
private boolean puertaAbierta = false;
    ...
    public Cubiculo2(List<ObjetoConColision> listaObstaculos) {
        ...
        ////////////////////////////////////DERECHA 1.3f, 2.2f, 0.1f, new Vector3d(-2.4, 1.1, 2.6)
//       tgCubiculo.addChild(Pared.crearPared(1.0f, 1.0f, 0.1f, new Vector3d(0.0, 1.5, 4.0), crearApariencia(180, 150, 100)));///ventana de cubiculo
 tgCubiculo.addChild(Pared.crearPared(1.1f, 2.6f, 0.1f, new Vector3d(0.4, 0.7, 2.4), crearApariencia(160, 50, 50))); // Puerta
       tgCubiculo.addChild(Pared.crearPared(1.1f, 2.6f, 0.1f, new Vector3d(0.4, 0.7, 4.0), crearApariencia(160, 50, 50))); // Puerta
       
       
       tgCubiculo.addChild(Pared.crearPared(2.9f, 0.5f, 0.1f, new Vector3d(-0.5, 2.3, 2.4), crearApariencia(155, 80, 15)));//divisor de cubiculos ==
       tgCubiculo.addChild(Pared.crearPared(1.8f, 1.4f, 0.1f, new Vector3d(-1.1, 0.1, 2.4), crearApariencia(155, 80, 15))); //pared serapadaorsa
       tgCubiculo.addChild(Pared.crearPared(0.12f, 2.9f, 0.1f, new Vector3d(-0.2, 1.0, 2.4), crearApariencia(160,160,160))); // delgado===
       tgCubiculo.addChild(Pared.crearPared(0.12f, 2.9f, 0.1f, new Vector3d(-1.9, 1.0, 2.4), crearApariencia(160,160,160))); // delgado
       
       tgCubiculo.addChild(Pared.crearParedConColision(2.9f, 1.4f, 0.1f, new Vector3d(-0.5, 0.1, 0.9), crearApariencia(155, 80, 15),"cb",listaObstaculos));// ventana que apunta hacia a abajo--- no tocar 
       tgCubiculo.addChild(Pared.crearParedConColision(2.9f, 0.5f, 0.1f, new Vector3d(-0.5, 2.3, 0.9), crearApariencia(155, 80, 15),"cb",listaObstaculos));// ventana que apunta hacia arriba -- no tocar
       
       tgCubiculo.addChild(Pared.crearPared(0.12f, 2.9f, 0.1f, new Vector3d(-1.9, 1.0, 4.0), crearApariencia(160,160,160))); // delgado
       tgCubiculo.addChild(Pared.crearPared(0.12f, 2.9f, 0.1f, new Vector3d(-0.2, 1.0, 4.0), crearApariencia(160,160,160))); // delgado==
       tgCubiculo.addChild(Pared.crearPared(2.9f, 0.5f, 0.1f, new Vector3d(-0.5, 2.3, 4.0), crearApariencia(155, 80, 15)));//divisor de cubiculos  ===
       tgCubiculo.addChild(Pared.crearPared(1.8f, 1.4f, 0.1f, new Vector3d(-1.1, 0.1, 4.0), crearApariencia(155, 80, 15))); //pared serapadaorsa
