...
public class Cubiculo extends BranchGroup {
    ...
    public Cubiculo(List<ObjetoConColision> obstaculos, Vector3d posicion) {
       ...
       tgCubiculo.addChild(Pared.crearPared(3.0f, 1.4f, 0.1f,
               new Vector3d(-0.5, 1.5, 3.9), Color.setSemiTransparente(0.1f)));
       tgCubiculo.addChild(Pared.crearPared(1.6f, 1.2f, 0.1f,
               new Vector3d(-1.0, 1.5, 2.4), Color.setSemiTransparente(0.1f)));
       tgCubiculo.addChild(Pared.crearPared(1.6f, 1.2f, 0.1f,
               new Vector3d(-1.0, 1.5, 1.0), Color.setSemiTransparente(0.1f)));
       
       
       
        tgCubiculo.addChild(Pared.crearParedConColision(1.1f, 2.6f, 0.1f,
                new Vector3d(0.4, 0.7, 0.9), crearApariencia(160, 50, 50), "puertaCubiculo1", obstaculos ));
        tgCubiculo.addChild(Pared.crearParedConColision(1.1f, 2.6f, 0.1f,
                new Vector3d(0.4, 0.7, 2.4), crearApariencia(160, 50, 50), "puertaCubiculo2", obstaculos ));

        tgCubiculo.addChild(Pared.crearParedConColision(2.9f, 1.4f, 0.1f,
                new Vector3d(-0.5, 0.1, 4.0), crearApariencia(155, 80, 15), "ventanaAbajo", obstaculos ));
        tgCubiculo.addChild(Pared.crearParedConColision(2.9f, 0.5f, 0.1f,
                new Vector3d(-0.5, 2.3, 4.0), crearApariencia(155, 80, 15), "ventanaArriba", obstaculos));
        tgCubiculo.addChild(Pared.crearParedConColision(2.9f, 0.5f, 0.1f,
                new Vector3d(-0.5, 2.3, 2.4), crearApariencia(155, 80, 15), "divisorCubiculo1", obstaculos));
        tgCubiculo.addChild(Pared.crearParedConColision(2.9f, 0.5f, 0.1f,
                new Vector3d(-0.5, 2.3, 0.9), crearApariencia(155, 80, 15), "divisorCubiculo2", obstaculos));
        tgCubiculo.addChild(Pared.crearParedConColision(1.8f, 1.4f, 0.1f,
                new Vector3d(-1.1, 0.1, 2.4), crearApariencia(155, 80, 15), "paredSeparadora1", obstaculos));
        tgCubiculo.addChild(Pared.crearParedConColision(1.8f, 1.4f, 0.1f,
                new Vector3d(-1.1, 0.1, 0.9), crearApariencia(155, 80, 15), "paredSeparadora2", obstaculos));

        tgCubiculo.addChild(Pared.crearParedConColision(0.12f, 2.9f, 0.1f,
                new Vector3d(-0.2, 1.0, 0.9), crearApariencia(160,160,160), "pilarDelgado1", obstaculos));
        tgCubiculo.addChild(Pared.crearParedConColision(0.12f, 2.9f, 0.1f,
                new Vector3d(-0.2, 1.0, 2.4), crearApariencia(160,160,160), "pilarDelgado2", obstaculos));

        tgCubiculo.addChild(Pared.crearParedConColision(0.12f, 2.9f, 0.1f,
                new Vector3d(-1.9, 1.0, 0.9), crearApariencia(160,160,160), "pilarDelgado3", obstaculos));
        tgCubiculo.addChild(Pared.crearParedConColision(0.12f, 2.9f, 0.1f,
                new Vector3d(-1.9, 1.0, 2.4), crearApariencia(160,160,160), "pilarDelgado4", obstaculos));

                // Primer par (Z positivo)
        Vector3d posMesa = new Vector3d(-1.2, 0.05, 3.2);
        Vector3d posSilla = new Vector3d(-1.35, 0.05, 3.2);
