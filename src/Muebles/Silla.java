...
public class Silla {
    ...
    public Silla(Vector3d posicion,List<ObjetoConColision> listaObstaculos) {
        ...
        ///// ASIENTO Y RESPALDO
        tgSilla.addChild(Pared.crearParedConColision(0.6f, 0.05f, 0.6f,
                new Vector3d(0.0, 0.3, 0.0),colorAsiento, "s", listaObstaculos));    // Asiento
        tgSilla.addChild(Pared.crearParedConColision(0.5f, 0.7f, 0.05f,
                new Vector3d(0.0, 0.7, -0.3),colorAsiento, "s", listaObstaculos));
